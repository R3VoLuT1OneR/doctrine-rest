...
namespace Pz\Doctrine\Rest\Tests;

use Doctrine\Common\Cache\ArrayCache;
use Doctrine\ORM\Cache\DefaultCacheFactory;
use PHPUnit\Framework\TestCase;
use Pz\Doctrine\Rest\Tests\Mocks\ConnectionMock;
use Pz\Doctrine\Rest\Tests\Mocks\DriverMock;
...
abstract class DoctrineTest extends TestCase
{
    ...
    protected function _getTestEntityManager($conn = null, $conf = null, $eventManager = null, $withSharedMetadata = true)
    {
        ...
        return \Pz\Doctrine\Rest\Tests\Mocks\EntityManagerMock::create($conn, $config, $eventManager);
    }
