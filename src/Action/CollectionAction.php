...
use Doctrine\Rest\BuilderChain\CriteriaChain;
use Doctrine\Rest\QueryParser\ArrayFilterParser;
use Doctrine\Rest\QueryParser\FilterParserAbstract;
use Doctrine\Rest\QueryParser\SearchFilterParser;
use Doctrine\Rest\Resource\Collection;
